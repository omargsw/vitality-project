class WebConfig {
  ...
  static String customerLogin = '/CustomerLogin.php';
  ...
  static String adminAddCategory = '/AdminAddCategory.php';
  static String adminUpdateCategory = '/AdminUpdateCategory.php';
  static String adminUpdateCatImage = '/AdminUpdateCatImage.php';
  static String adminRemoveCategory = '/AdminRemoveCategory.php';

  static String addAdvertisment = '/AddAdvertisment.php';
  static String adminUpdateAdv = '/AdminUpdateAdv.php';
  static String adminUpdateAdvImage = '/AdminUpdateAdvImage.php';
  static String adminRemovAdv = '/AdminRemovAdv.php';

  static String adminViewCustomers = '/AdminViewCustomers.php';
  ...
  static String centerAddFood = '/CenterAddFood.php';
  static String centerRemoveFoodPlan = '/CenterRemoveFoodPlan.php';
